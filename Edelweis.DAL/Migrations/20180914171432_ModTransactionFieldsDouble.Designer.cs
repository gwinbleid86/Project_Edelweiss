...
namespace Edelweiss.DAL.Migrations
{
    ...
    [Migration("20180914171432_ModTransactionFieldsDouble")]
    partial class ModTransactionFieldsDouble
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edelweiss.DAL.Entities.Commission", b =>
                {
                    ...
                    b.Property<int>("SysTransactionId");

                    b.HasKey("Id");

                    b.HasIndex("SysTransactionId");
            ...
            modelBuilder.Entity("Edelweiss.DAL.Entities.SysTransaction", b =>
                {
                    ...
                    b.Property<double>("AgentFromCommission");

                    b.Property<int>("AgentFromId");

                    b.Property<double>("AgentToCommission");
                    ...
                    b.Property<double>("SystemCommission");
            ...
            modelBuilder.Entity("Edelweiss.DAL.Entities.AgentCommission", b =>
                {
                    b.HasBaseType("Edelweiss.DAL.Entities.Commission");
                    ...
                    b.HasDiscriminator().HasValue("AgentCommission");
                });
            ...
            modelBuilder.Entity("Edelweiss.DAL.Entities.Commission", b =>
                {
                    b.HasOne("Edelweiss.DAL.Entities.SysTransaction", "SysTransaction")
                        .WithMany("Commissions")
                        .HasForeignKey("SysTransactionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
