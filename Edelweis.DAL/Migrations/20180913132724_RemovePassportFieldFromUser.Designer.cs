...
namespace Edelweiss.DAL.Migrations
{
    ...
    [Migration("20180913132724_RemovePassportFieldFromUser")]
    partial class RemovePassportFieldFromUser
    {
            ...
            modelBuilder.Entity("Edelweiss.DAL.Entities.Tariff", b =>
                {
                    b.HasOne("Edelweiss.DAL.Entities.Agent", "Agent")
                        .WithOne("Tariff")
                        .HasForeignKey("Edelweiss.DAL.Entities.Tariff", "AgentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Edelweiss.DAL.Entities.Country", "Country")
                        .WithOne("Tariff")
                        .HasForeignKey("Edelweiss.DAL.Entities.Tariff", "CountryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Edelweiss.DAL.Entities.Currency", "Currency")
                        .WithOne("Tariff")
                        .HasForeignKey("Edelweiss.DAL.Entities.Tariff", "CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
