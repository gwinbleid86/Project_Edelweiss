        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentToId = table.Column<int>(nullable: true),
                    UserFromId = table.Column<string>(nullable: true),
                    UserToId = table.Column<string>(nullable: true),
                    ClientFromId = table.Column<int>(nullable: false),
                    ClientToId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transactions_Agents_AgentFromId",
                        column: x => x.AgentFromId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Agents_AgentToId",
                        column: x => x.AgentToId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Transactions_Clients_ClientFromId",
                        column: x => x.ClientFromId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Clients_ClientToId",
                        column: x => x.ClientToId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AgentFromId",
                table: "Transactions",
                column: "AgentFromId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AgentToId",
                table: "Transactions",
                column: "AgentToId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ClientFromId",
                table: "Transactions",
                column: "ClientFromId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ClientToId",
                table: "Transactions",
                column: "ClientToId");
        }
